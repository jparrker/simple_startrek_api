...
const connectionstring = 'mongodb+srv://anon:VVMA6vDix5RWjO4V@cluster0.vx45v.mongodb.net/?retryWrites=true&w=majority'
...
.then(client => {
  ...
  const db = client.db('startrek-facts')
  const infoCollection = db.collection('aliens')
